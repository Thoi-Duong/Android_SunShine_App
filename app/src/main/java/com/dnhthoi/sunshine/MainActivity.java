...
import com.dnhthoi.sunshine.sync.SunshineSyncAdapter;
...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback {
    ...
    public static final String PROJECT_NUMBER = "206856959859";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (checkPlayServices()) {
            Log.e("checkPlayServices::", "Sucseced");
            ...
            if (PROJECT_NUMBER.equals("Your Project Number")) {
                ...
                Log.e("registerInBackground::","Start");
